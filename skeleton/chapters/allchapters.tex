...
\hhline{~~--} &  & \textsc{ii}. & Derivational Concepts\\
...
technique & {isolating} & {{\textgreater}} & {analytic} & {{\textgreater}} & {synthetic-

agglutinating} & {{\textgreater}} & {synthetic-

flexional} & {\textgreater} & zero\\
 {} & {↑} & {} & {↑} & {} & {↑} & {} &  & \\
phase & \multicolumn{9}{l}{~~~~~~syntacticization~~~morphologization~~demorphemicization loss}\\
 {}\\
process & \multicolumn{8}{l}{ grammaticalization} & \\
\lspbottomrule
\end{tabular}
...
D1  determiner of 1.ps. deixis

D3  determiner of 3.ps. deixis
