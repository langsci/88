...
\begin{tikzpicture}[baseline=(current bounding box.north), decoration = {markings, mark=at position .75 with {\arrow[thick]{Stealth[sep] Stealth[]}}}]
...
\langinfo{Efik}{}{}\\
\gll dá  íkwâ  dí!  \\
 take  knife  come  ‘Bring a knife!’    \citep[369]{Welmers1973}\\
\z

\ea\label{ex:}
\langinfo{Ewe}{}{} \\
\gll é  nò  ts\=i  kú.  \\
he  drink  water  die  ‘He drowned.’    (W. Kuhn p.c.)\\
\z
...
\lspbottomrule
\end{tabular}
\todo[inline]{This still needs some work}
