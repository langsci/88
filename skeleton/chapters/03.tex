...
\begin{exe}
\exi{E1}\label{ex:}
\langinfo{\LangSwah}{}{\citet[916]{Givón1973}}
 \ea
 \gll n-a-taka ku-la \\   
...
\ea He does plough the field for us. (John Harris p.c.)\\
\z
...
\begin{tikzpicture}[baseline=(current bounding box.north), decoration = {markings, mark=at position .75 with {\arrow[thick]}}]
...
\draw [->, very thick] (node cs:name=full) -- (node cs:name=modal);
\draw [->, very thick] (node cs:name=full) -- (node cs:name=auxiliary);
\draw [->, very thick] (node cs:name=full) -- (node cs:name=serial);
\draw [->, very thick] (node cs:name=modal) -- (node cs:name=auxiliary);
\draw [->, very thick] (node cs:name=auxiliary) -- (node cs:name=mood);
\draw [->, very thick] (node cs:name=auxiliary) -- (node cs:name=aspect);
\draw [->, very thick] (node cs:name=serial) -- (node cs:name=aspect);
\draw [->, very thick] (node cs:name=aspect) -- (node cs:name=tense);
\draw [->, very thick] (node cs:name=adverb) -- (node cs:name=tense);
\end{tikzpicture}
\caption{Some interrelated grammaticalization channels of verbal categories}
\end{figure}
...
\begin{figure}
	...
	\caption{Some interrelated grammaticalization channels of pronominal elements}
\end{figure}
...
\multicolumn{2}{l}{\textsc{stage}} & \multicolumn{2}{l}{\textsc{category}} & \\
\midrule
I. &  & \begin{tikzpicture}[overlay, on grid, baseline={([yshift=-.5ex]current bounding box.center)}, remember picture] \node at (.125,0) (F6-1V) {V}; \end{tikzpicture} & {}-- & The word occurs only as a verb.\\
&  & \multicolumn{2}{l}{} & \\
...
\todo[inline]{need to draw F8 here. See pg. 99 of the original PDF}
